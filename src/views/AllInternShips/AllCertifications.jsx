...
const AllCertifications = (props) => {
  ...
  const [isgetCertificationDetails, setisgetCertificationDetails] = useState(false);


  useEffect(() => {
    if (!isgetCertificationDetails) {
  ...
  const getcertificationDeatils = async () => {
    try {
      ...
      setloading(false);
      setisgetCertificationDetails(true);
  ...
  const handleChangePage = (e, newPage) => {
    ...
    setisgetCertificationDetails(false);
  };
  ...
  const handleClickOpenCertificationDetails = async (id) => {
    ...
    const handleChangeDepartment = async (name) => {
      ...
      console.log(certificationlistparameters);
    };
