...
const ForgotPasswordPage = () => {
  ...
  const [resetPasswordValidate_status, setResetPasswordValidate_status] =
    useState(false);
  const [
    confirmResetPasswordValidate_status,
    setConfirmResetPasswordValidate_status,
  ] = useState(false);
  ...
  useEffect(() => {
    if (params.passwordfunction === "changepassword") {
      if (localStorage.getItem("MITSinternsid")) {
        ...
        toast.error(
          "You must Login to change your password or click on 'forgot password' to reset your password. "
        );
